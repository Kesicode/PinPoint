...
// The native PinPointGnss binding throws requireNativeModule in Jest.
jest.mock('PinPoint-sdk/src/gnss/PinPointGnssModule', () => ({
  __esModule: true,
  default: {
...
// The native PinPointNet binding throws requireNativeModule in Jest.
jest.mock('PinPoint-sdk/src/gnss/PinPointNetModule', () => ({
  __esModule: true,
  default: {
    isVpnActive: () => false,
  },
...
jest.mock('pinpoint-sdk', () => {
  const actual = jest.requireActual('pinpoint-sdk') as Record<string, unknown>;
  return {
    ...actual,
    PinPointProvider: ({ children }: { children?: unknown }) => children ?? null,
