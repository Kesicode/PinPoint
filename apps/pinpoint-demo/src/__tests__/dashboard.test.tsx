...
const cleanFixture = require('../../../../packages/PinPoint-sdk/src/__tests__/fixtures/clean-drive.json') as Fixture;
const spoofedFixture = require('../../../../packages/PinPoint-sdk/src/__tests__/fixtures/spoofed-jump.json') as Fixture;
