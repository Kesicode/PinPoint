import type { PinPointSDK, IntegrityState, SensorWindow, Verdict } from '../types';
...
/**
 * Creates the public PinPointSDK instance.
 *
 ...
 * call and never touch the state machine: `PinPointSDK` exposes no mutation
 * path, which is the type-level guarantee that AI cannot alter state.
 */
export function createPinPointSDK(): PinPointSDK {
