 ...
 *  - PinPointProvider pre-warms the SAME caches, so a mounted provider and
 *    createPinPointSDK() share one loaded model per task instead of two.
...
/** Fire-and-forget pre-warm used by PinPointProvider; errors are rethrown at call time. */
